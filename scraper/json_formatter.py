...
def convert_tex_to_txt(tex_file, output_dir="./converted_text"):
    """
    Converts a .tex file to plain text using Pandoc and returns the text content.
    """
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            return result.stdout.strip()  # Return the plain text content
        else:
    ...
    try:
        ...
        if "arxiv.org/abs/" in url:
            ...
            if os.path.exists(tex_file):
                ...
                return convert_tex_to_txt(tex_file)
